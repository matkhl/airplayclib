...
#define TARGET_RT_LITTLE_ENDIAN 1
#elif defined (TARGET_OS_WIN32) || defined(_WIN32) || defined(_M_IX86) || \
      defined(_M_X64) || defined(_M_AMD64) || defined(_M_ARM) || defined(_M_ARM64)
// MSVC defines _M_X64/_M_IX86/_WIN32, NOT the GCC/Clang __x86_64__ macros, so
// without this the swap functions were no-ops on MSVC and the big-endian ALAC
// magic cookie was misread (frameLength 352 -> 0x60010000 -> ~18 GiB calloc).
#define TARGET_RT_LITTLE_ENDIAN 1
#endif
